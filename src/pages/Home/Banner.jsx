  ...
  return (
    <div className="relative overflow-x-hidden">
      ...
      <div className="relative z-10 mt-[-40px] px-4">
        <div className="bg-white shadow-lg rounded-lg grid grid-cols-1 md:grid-cols-3 gap-6 p-6 md:p-10 max-w-6xl mx-auto text-center">
          <div>
            <h3 className="text-xl font-bold text-gray-700 mb-2">Authentic Experiences</h3>
            <p className="text-gray-600 text-sm">Connect with local culture, cuisine, and landscapes like never before.</p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-gray-700 mb-2">Expert Tour Guides</h3>
            <p className="text-gray-600 text-sm">Our certified guides make your journey safer and more enriching.</p>
          </div>
          <div>
            <h3 className="text-xl font-bold text-gray-700 mb-2">Tailored Tour Packages</h3>
