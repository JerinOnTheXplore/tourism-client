...
const QuizLanding = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-100 flex items-center justify-center px-4 py-12">
      <div className="max-w-3xl w-full text-center space-y-6">
        ...
        >
          ...
          <p className="text-gray-700 mb-4">Answer a few quick questions and find your perfect match ✈️</p>
        </motion.div>

        {!submitted ? (
          <form className="space-y-8">
            {questions.map((q) => (
              <div key={q.id} className="bg-white p-6 rounded-xl shadow border text-left">
                <h3 className="text-lg font-semibold text-blue-700 mb-3">{q.question}</h3>
